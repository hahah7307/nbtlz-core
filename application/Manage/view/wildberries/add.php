        ...
        <div class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="wb_order_code" placeholder="请填写WB平台订单号">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label w100">WB产品编号</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="wb_product_code" placeholder="请填写WB产品编号">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="qty" placeholder="请填写数量">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label w100">颜色</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="color" placeholder="请填写颜色">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label w100">尺寸</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="size" placeholder="请填写尺寸">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label w100">采购链接</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="purchase_url" placeholder="请填写采购编号">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label w100">包装要求</label>
                <div class="layui-input-inline w300">
                    <textarea name="packaging_requirements" placeholder="请填写包装要求" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
